...
| **Week 15** | Jun 4 | SVD and Positive Semidefinite Geometry | [View Details](tutorials/week15-svd-positive-definite.md) |
...
| **HW3** | Week 8 (Apr 20) | Week 10 (Apr 30) | Week 12 (May 14) | Ch4: Determinants, Cayley-Hamilton theorem | [PDF](files/hw03.pdf) · [Solutions](files/hw03-sol.pdf) |
| **HW4** | Week 11 (May 4) | Week 13 (May 21) | Week 15 (June 04) | Ch5-6: Spectral decomposition, normal matrices, SVD | [PDF](files/hw05.pdf) · [Solutions](files/hw05-sol.pdf) |
...
- [Lecture 14: Cayley–Hamilton Theorem](notes/cayley-hamilton.md) — **[Slides](files/lecture14-slides.pdf)** — Annihilating polynomials, computing $A^n$, characteristic polynomial $\det(\lambda I - A)$, polynomial division (scalar and matrix), remainder theorem, adjugate proof of Cayley–Hamilton
...
- [Lecture 18: The Exponential Function](notes/exponential-function.md) — **[Slides](files/lecture18-slides.pdf)** — Definition of $e$ via compound interest, binomial expansion → power series, $y'=ky$ and differential equations, Euler's formula $e^{i\theta}=\cos\theta+i\sin\theta$ (geometric and series proofs), exponential of $d/dx$ = shift operator (Taylor's theorem IS binomial expansion), matrix exponential $e^{As}=\sum e^{\lambda_i s}P_i$, complex eigenvalues → rotation
- [Lecture 19: Normal Matrices](notes/normal-matrices.md) — **[Slides](files/lecture19-slides.pdf)** — Hermitian inner product and conjugate transpose, normal matrices, nilpotent-normal lemma, normal $\Rightarrow$ diagonalizable, Hermitian spectral projections, orthogonal eigenspace decomposition, unitary diagonalization via diagonal cross-filling, and special normal matrices (Hermitian, skew-Hermitian, unitary).
- [Lecture 20: Singular Value Decomposition](notes/singular-value-decomposition.md) — **[Slides](files/lecture20-slides.pdf)** — Real SVD as the axis system of a matrix: round ball to ellipsoid, $A^TA$ as the stretch-measuring symmetric matrix, input axes $v_i$, singular values $\sigma_i$, output axes $u_i$, and the method $A=U\Sigma V^T$.
- [Lecture 21: Positive Definite and Positive Semidefinite Matrices](notes/positive-definite-matrices.md) — **[Slides](files/lecture21-slides.pdf)** — Quadratic forms as squared-length machines, ellipse/degenerate/hyperbola geometry, eigenvalue and factorization criteria, Cauchy inequality for PSD forms, diagonal cross-filling criterion, and the bridge to principal determinant tests.
